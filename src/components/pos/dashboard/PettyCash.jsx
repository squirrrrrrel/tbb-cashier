        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20" onClick={() => setIsPettyClicked(false)}>
            <div className="bg-white rounded-md shadow-2xl w-[400px] py-5 px-6 animate-in zoom-in duration-200" onClick={e => e.stopPropagation()}>
                ...
                <input
                    ...
                    className='w-full p-2 outline outline-gray-200 bg-white rounded-md mt-5'
                />
                <div className="submit-button mt-5 text-gray-700 font-semibold flex gap-4">
                    <button onClick={() => sendPettyPayload()} className="button p-2 text-base bg-linear-to-b from-primary to-secondary text-white text-center rounded-md w-full cursor-pointer flex gap-2 justify-center items-center"><svg viewBox="64 64 896 896" focusable="false" data-icon="plus" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M482 152h60q8 0 8 8v704q0 8-8 8h-60q-8 0-8-8V160q0-8 8-8z"></path><path d="M176 474h672q8 0 8 8v60q0 8-8 8H176q-8 0-8-8v-60q0-8 8-8z"></path></svg>ADD</button>
                    <button onClick={() => setIsPettyClicked(false)} className="button p-2 text-base bg-white text-center rounded-md w-full outline outline-gray-200 cursor-pointer flex gap-2 justify-center items-center"><svg viewBox="64 64 896 896" focusable="false" data-icon="close" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z"></path></svg>CANCEL</button>
                </div>
            </div>
        </div>
    )
