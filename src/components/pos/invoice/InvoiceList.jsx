const invoiceList = ({ orders, selectedOrder, setSelectedOrder, setSearchTerm, searchTerm }) => {
    return (
        <div className="px-1 flex flex-col h-full min-h-0">
            ...
            <div className="search relative mt-4 mb-2 flex items-center gap-3 px-1.5 bg-background flex-shrink-0">
            <svg
            ...
            {orders.length === 0 ? (
                ...
                <ul className="py-0.5 p-1 flex-grow overflow-y-auto min-h-0 text-secondary">
                    {orders.map((order) => {
