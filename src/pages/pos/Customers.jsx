...
const Customers = () => {
  ...
  return (
    <div className="w-full h-full flex ">
      <div className="customer-list w-3/5 bg-background  p-2 flex flex-col h-full mb-1">

        <div className="customer-list-header bg-background mb-2 ">
          <h2 className="text-2xl font-semibold text-gray-700">Customers</h2>
          <div className="search relative mt-4 flex items-center gap-3 ">
            <svg
              className="absolute left-3 top-3 w-4 h-5 text-gray-500"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <input
              ...
              className="p-2 pl-10 border border-gray-100 bg-white rounded-md w-4/5 shadow-sm outline-0 cursor-text placeholder-gray-500 placeholder:text-sm"
            />
